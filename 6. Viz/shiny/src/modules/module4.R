               ...
               , wellPanel(
                 ...
                 , fluidRow(
                   ...
                   , column(width = 4, style = "padding-left:60px"
                     , br(), br(), br()
                     , p("This is a graphical representation of all contracts available in SECOP. The color represents the natural groups (clusters) formed after mathematical computations. <b>Each cluster contain the contracts on which their description is the closest to each other</b>.")
                     , br()
                     , p("The cluster 6 (colored blue) has 65% of all the data classified in it. The contracts that are in this cluster are the ones related to <b>audiovisuals, environment issues, municipalities and castral information</b>. This cluster contains several amount of contracts related to evaluation of properties at municipal and departmental level.")
                     , br()
                     , p("The cluster 5 (colored light blue) shares 9% of all contracts. It contains contracts that are related to <b>monitoring and surveillance of the execution of projects.</b>")
                     , br()
                     , p("Finally the third most dense cluster is the 8th with a share of 6% of the data, this cluster is related to all the contracts in the <b>health and environmental sector</b>.")
                     , br()                            
                  )
