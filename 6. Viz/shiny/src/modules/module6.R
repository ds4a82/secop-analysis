module6UI <- function(id){
  ...
  main <- list(""
    ...
    , fluidRow(
      ...
      , column(width = 2)
      , column(width = 8
               , HTML('<iframe width="100%" height="500" src="/7. Report/Team82_Report.pdf" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')
      )
      , column(width = 2)
    )  
