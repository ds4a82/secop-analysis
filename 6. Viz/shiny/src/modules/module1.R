...
module1UI <- function(id){
  ...
  main <- list(""
               ...
               , wellPanel(
                 h1("Context")
                 , img(src = "https://github.com/ds4a82/secop-analysis/blob/master/6.%20Viz/shiny/img/Context.png?raw=true", style="width:200px;height:200px;float: left;")
               ...
               , wellPanel(
                 h1("Solution")
                 , fluidRow(p("We have developed this application to provide a tool to Colombia Compra Efficient and the general public that allows them to achieve a greater understanding of the goods and services that public entities are buying. To build the app we follow this steps:")
