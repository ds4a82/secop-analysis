...
module1UI <- function(id){
  ...
  main <- list(""
               ...
               , wellPanel(
                 h1("Context")
                 , img(src = "https://github.com/ds4a82/secop-analysis/blob/master/6.%20Viz/shiny/img/Context.png?raw=true", style="width:220px;height:270px;float:right;")
               ...
               , wellPanel(
                 ...
                 , br()
                 , img(src = "https://github.com/ds4a82/secop-analysis/blob/master/6.%20Viz/shiny/img/Diagram.png?raw=true", style="width:900px;height:500px;display:block;margin-left:auto;margin-right:auto;")
               ))
               , br()
  )
  tagList(main)
